...
tleap -f $AMBERHOME/dat/leap/cmd/leaprc.DNA.bsc1  #in this case this forcefield is for DNA
  ...
  dna1= loadpdb "1bna.pdb" #after this command you don't want errors or warnings. 
#if you get warnings and errors
...
#for example 
  ...
  Loading PDB file: ./1bna.pdb
            ...
            Leap added 432 missing atoms according to residue templates:
                432 H / lone pairs
saveamberparm dna1 1bna.prmtop 1bna.crdbox
            ...
            dna2= loadpdb "4ocb.pdb"
            saveamberparm dna2 4ocb.prmtop 4ocb.rst7
            
            dna3= loadpdb "1qph.pdb"
            saveamberparm dna2 1qph.prmtop 1qph.rst7
quit 

~/scripts/amber2bgf.pl [prmtop] [crdbox] [name_of_bgf_file_to_create]
~/scripts/amber2bgf.pl 1qph.prmtop 1qph.rst7 1qph-tleap.bgf
~/scripts/amber2bgf.pl 1bna.prmtop 1bna.rst7 1bna-tleap1.bgf
